...
const OMNICHAN_ESCROWS = escrows.map((escrow) => ({
...
//     useContractName: true,
//     contract: {
//       name: 'agEUR Wrapped Token',
//     },
//     sinceTimestamp: new UnixTime(1657699079),
//     tokens: ['agEUR'],
//   },
//   // the tokens below have market cap < $1M
//   // {
//   //   // hmm, this token is a proxy...
//   //   address: EthereumAddress('0x1A36E24D61BC1aDa68C21C2Da1aD53EaB8E03e55'),
//   //   newVersion: true,
//   //   contract: {
//   //     name: 'BOBA Wrapped Token',
//   //   },
